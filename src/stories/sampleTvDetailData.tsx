...
export const tvCastMembers: TvCastMember[] = [
  {
    adult: false,
    gender: 2,
    id: 101112,
    ...
    popularity: 8.5,
    profile_path: "/michael-carter.jpg",
    character: "Detective Ron Harper",
    credit_id: "cred101xyz",
    order: 0,
    department: "Acting",
    job: "",
  },
  {
    ...
    name: "Alicia Bennett",
    original_name: "Alicia Bennett",
    popularity: 6.9,
    profile_path: "/alicia-bennett.jpg",
    character: "",
    credit_id: "cred202abc",
    order: 1,
  ...
  },
  {
    ...
    name: "Samuel Lee",
    original_name: "Samuel Lee",
    popularity: 5.4,
    profile_path: null,
    character: "",
    credit_id: "cred303def",
    order: 2,
    department: "Writing",
    job: "Screenwriter",
  },
